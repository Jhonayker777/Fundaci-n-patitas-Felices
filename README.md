...
Clona el repositorio: git clone https://github.com/usuario/patitas-felices.git

Entra a la carpeta del proyecto: cd patitas-felices

¡Ábrelo!: Abre index.html en tu navegador favorito. No requiere servidor ni dependencias externas. ☁️
...
└── fonts/              → Tipografías personalizadas (LuckiestGuy y Cafe Francoise)
...
Home / Hero	index.html	Banner principal, carrusel y sección de acciones.
...
Contacto	index.html	Formulario con validación visual y datos directos.
Footer	Ambas	Información, redes y copyright con Flexbox.
